...
/**
 * Tenant isolation for the Purchasing module, in the database.
 *
 * The same shape as the Sales module's policy migration, reusing `asids_current_tenant_id()`
 ...
 * for its first three runs, `RowLevelSecurityTest` skipped its assertions rather than passing
 * vacuously, and tenant isolation was verified by nothing at all.
 */
return new class extends Migration
{
    /**
     * Every Purchasing table. All carry a non-null `tenant_id`.
     *
     * @var list<string>
     */
